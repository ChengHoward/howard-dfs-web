	...
	var m = {
		...
		flexible: function(n) {
			...
			if (n) {
				...
				h(".images-logo").css("display","block");
			} else {
				h(".layui-layout-admin").addClass("admin-nav-mini")
				h(".images-logo").css("display","none");
			}
			m.removeNavHover()
		},
	...
	m.events = {
		...
		theme: function() {
			...
			m.popupRight({
				id: "layer-theme",
				type: 2,
				content: n ? n : "../static/layui/page/tpl/tpl-theme.html"
			})
		},
		note: function() {
			var n = h(this).attr("data-url");
			m.popupRight({
				...
				type: 2,
				closeBtn: false,
				content: n ? n : "../static/layui/page/tpl/tpl-note.html"
			})
		},
		message: function() {
			var n = h(this).attr("data-url");
			m.popupRight({
				id: "layer-notice",
				type: 2,
				content: n ? n : "../static/layui/page/tpl/tpl-message.html"
			})
		},
		psw: function() {
			var n = h(this).attr("data-url");
			m.open({
				id: "pswForm",
				type: 2,
				title: "<label style='font-weight: bold;'>修改密码</lable>",
				shade: 0,
				offset:'auto',
				content: n ? n : "../static/layui/page/tpl/tpl-password.html"
			})
		},
		logout: function() {
			var n = h(this).attr("data-url");
